...
private:
    ...
    size_t count = 0;
    const double decimation = 10; // RL control freqency 50hz
    ...
    const int dofmapping_obs2lab[13] = {
        0, 3, 6, 9,
        1, 4, 7, 10,
        2, 5, 8, 11
    };
    const int dofmapping_lab2obs[13] = {
        0, 4, 8, 
        1, 5, 9,
        2, 6, 10,
        3, 7, 11
