...
// Attempt to set the process scheduling policy to real-time First-In-First-Out (FIFO) to ensure the response time and execution order of critical tasks.
...
int main(int argc, char **argv)
{
    ...
    // ctrlComp->dt = 0.005; // run at 200hz
    ...
    // Create the estimator and the balancing controller.
    ctrlComp->geneObj();  
