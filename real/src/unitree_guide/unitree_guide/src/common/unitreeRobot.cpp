...
//   _robVelLimitYaw << -0.5, 0.5;
  ...
  _robVelLimitY << -1.0, 1.0;
  _robVelLimitYaw << -3.14, 3.14;
...
Go2Robot::Go2Robot(){
    _Legs[0] = new Go2Leg(0, Vec3(0.19257, -0.046492, 0));
    _Legs[1] = new Go2Leg(1, Vec3(0.19257, 0.046492, 0));
    _Legs[2] = new Go2Leg(2, Vec3(-0.19257, -0.046492, 0));
    _Legs[3] = new Go2Leg(3, Vec3(-0.19257, 0.046492, 0));
    
    _feetPosNormalStand << 0.19257, 0.19257, -0.19257, -0.19257,
        -(0.088508 + 0.046492), (0.088508 + 0.046492), -(0.088508 + 0.046492), (0.088508 + 0.046492),
        -0.3200, -0.3200, -0.3200, -0.3200;

    _robVelLimitX << -1.1, 1.1;
    _robVelLimitY << -0.3, 0.3;
    _robVelLimitYaw << -0.5, 0.5;

#ifdef COMPILE_WITH_REAL_ROBOT
    _mass = 6.921 + 0.678 * 4 + 1.152 * 4 + 0.154 * 4;
    _pcb << 0.0, 0.0, 0.0;
    _Ib = Vec3(0.0792, 0.2085, 0.2265).asDiagonal();
#endif // COMPILE_WITH_REAL_ROBOT
