...
class HIMManagerBasedRLEnv(ManagerBasedEnv, gym.Env):
    ...
    def step(self, action: torch.Tensor) -> VecEnvStepReturn:
        ...
        # print(self.action_manager.jointnames)
        ...
        self.critic_buf_before_reset = self.observation_manager.compute_group("before_step_Critic")
        ...
        self.extras["critic_before_reset"] = self.critic_buf_before_reset
        # print(self.obs_buf["critic"])
