...
def export_HIM_policy_as_jit(actor_critic: object, normalizer: object | None, path: str, filename="policy.pt"):
    """Export policy into a Torch JIT file.
    ...
    Args:
        ...
        filename: The name of exported JIT file. Defaults to "policy.pt".
    """
    policy_exporter = _TorchHIMPolicyExporter(actor_critic, normalizer)
    policy_exporter.export(path, filename)
...
class _TorchHIMPolicyExporter(torch.nn.Module):
    ...
    def forward(self, obs_history):
        ...
        return self.actor(torch.cat((obs_history[:, 0:52], vel, z), dim=1))
