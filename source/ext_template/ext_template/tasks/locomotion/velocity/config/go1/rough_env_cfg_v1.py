...
class RewardsCfg:
    ...
    # pen_gait_when_zero_command = RewTerm(
    #     func=mdp.GaitRewardQuad_NoCommand,
    #     weight=1.0,
    #     params={
    #         "tracking_contacts_shaped_force": -1.0,
    #         "tracking_contacts_shaped_vel": -1.0,
    #         "gait_force_sigma": 35.0,
    #         "gait_vel_sigma": 0.25,
    #         "kappa_gait_probs": 0.05,
    #         "command_name": "gait_command",
    #         "sensor_cfg": SceneEntityCfg("contact_forces", body_names=".*_foot"),
    #         "asset_cfg": SceneEntityCfg("robot", body_names=".*_foot"),
    #         "basic_command_name": "base_velocity"
    #     },
    # )
    ...
    pen_gait_reward = RewTerm(
        ...
        params={
            "tracking_contacts_shaped_force": -1.0,
            "tracking_contacts_shaped_vel": -1.0,
            "gait_force_sigma": 50.0,# 35
            "gait_vel_sigma": 1.25,# 0.25
            "kappa_gait_probs": 0.05,
            "command_name": "gait_command",
            "sensor_cfg": SceneEntityCfg("contact_forces", body_names=".*_foot"),
            "asset_cfg": SceneEntityCfg("robot", body_names=".*_foot"),
...
##
@configclass
class UnitreeGo1EnvCfg_v1(ManagerBasedRLEnvCfg):
