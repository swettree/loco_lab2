...
def run_mujoco(policy, cfg):
    ...
    for i in range(int(cfg.sim_config.sim_duration / cfg.sim_config.dt)):
        ...
        if count_lowlevel % cfg.sim_config.decimation == 0:
            ...
            current_obs[0, 3] = omega[0] * cfg.normalization.obs_scales.ang_vel
            current_obs[0, 4] = omega[1] * cfg.normalization.obs_scales.ang_vel
            current_obs[0, 5] = omega[2] * cfg.normalization.obs_scales.ang_vel
            current_obs[0, 6:9] = gvec
            current_obs[0, 9:21] = (q - cfg.robot_config.default_dof_pos) * cfg.normalization.obs_scales.dof_pos
            # current_obs[0, 9:21] = q * cfg.normalization.obs_scales.dof_pos
            current_obs[0, 21:33] = dq * cfg.normalization.obs_scales.dof_vel
            current_obs[0, 33:45] = action
